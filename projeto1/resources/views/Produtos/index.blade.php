...
@section('content')
		...
		<div class="col-md-12">
			<form method="POST" action="{{url('produtos/busca')}}">
				...
				<div class="input-group mb-3">
					<input type="text" class="form-control" name="busca" id="busca" placeholder="Procurar produto no site..." value="{{$buscar}}">
	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			@endif
			<h4 class="text-center"><a href="{{URL::to('produtos')}}/{{$produto->id}}">{{$produto->titulo}}</h4>
